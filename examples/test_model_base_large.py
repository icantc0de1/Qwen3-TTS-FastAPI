...
"""API-based test for Qwen3-TTS 1.7B Base model.

This script tests the base model (1.7B) voice cloning via FastAPI server
...
def send_api_request(
    ...
    model: str = "qwen3-tts-12hz-1.7b-base",
...
def main() -> None:
    ...
    OUT_DIR = "qwen3_tts_test_api_base_large_output_wav"
    ...
    # Run test cases
    print("\n" + "=" * 70)
    print("Starting API-based base model (1.7B) tests")
    print("=" * 70)

    # Case 1: prompt single + synth single, ICL mode
    run_case(
        API_BASE_URL,
        OUT_DIR,
    ...
    print("\n" + "=" * 70)
    print("API-based base model (1.7B) tests completed")
