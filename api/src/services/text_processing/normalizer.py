# Copyright 2024-2026 Qwen3-TTS-FastAPI Contributors
# Copyright 2024 remsky (https://github.com/remsky/kokoro-fastapi)
#
...
#
# Attribution: This text normalization module is derived from the excellent
# work by remsky in the kokoro-fastapi project (https://github.com/remsky/kokoro-fastapi)
# and has been adapted for use with the Qwen3 TTS model.
